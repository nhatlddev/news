...
if (!function_exists('getLogo')) {
    function getLogo()
    {
        ...
        if (!empty($generalSettings)) {
            ...
            return base_url("assets/img/uni-logo_trans.png");
        }
        return base_url("assets/img/uni-logo_trans.png");
    }
}
...
if (!function_exists('getLogoFooter')) {
    function getLogoFooter()
    {
        ...
        if (!empty($generalSettings)) {
            ...
            return base_url("assets/img/uni-logo.jpg");
        }
        return base_url("assets/img/uni-logo.jpg");
    }
}
...
if (!function_exists('formatDateFront')) {
    ...
    {
        if (!empty($timestamp)) {
            $date = date("j/m/Y", strtotime($timestamp));
...
if (!function_exists('getPostByCategoryId')) {
    ...
    {
        $model = new \App\Models\PostModel();
        $posts = $model->getPostByCategoryId($categoryId);
        // $posts = getCachedData('post_category');
        // if (empty($posts)) {
        //     $model = new \App\Models\PostModel();
        //     $posts = $model->getNewsPost($categoryId);
        //     setCacheData('post_category', $posts);
        // }
        return $posts;
    }
}
...
if (!function_exists('getCategoryFooter')) {
    function getCategoryFooter($limit)
    {
        // $key = 'category_footer_' . $limit;
        // $categoryFooter = getCachedData($key);
        // if (empty($categoryFooter)) {
            $model = new \App\Models\CategoryModel();
            $categoryFooter = $model->getCategoryByFooter();
            // setCacheData($key, $categoryFooter);
        // }
