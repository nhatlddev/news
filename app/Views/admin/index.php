    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box admin-small-box bg-danger">
                <div class="inner">
                    <h3 class="increase-count"><?= $categoryCount; ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box admin-small-box bg-warning">
                <div class="inner">
                    <h3 class="increase-count"><?= $totalPostView; ?></h3>
                    <a>
                        <p><?= trans("total_page_view"); ?></p>
                    </a>
                </div>
                <div class="icon">
                    <a href="<?= adminURL('scheduled-posts'); ?>"><i class="fa fa-eye"></i></a>
                </div>
            </div>
        </div>
    </div>
