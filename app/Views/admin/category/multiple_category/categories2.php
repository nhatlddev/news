    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <div class="right">
                    <a href="<?= adminUrl('add-category'); ?>" class="btn btn-success btn-add-new"><i class="fa fa-plus"></i><?= trans("add_category"); ?></a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <thead>
                                <tr role="row">
                                    <th width="20" class="text-center text-nowrap"><?= trans('id'); ?></th>
                                    <th class="text-center text-nowrap"><?= trans('category_name'); ?></th>
                                    <!-- <th class="text-center text-nowrap"><?= trans('language'); ?></th> -->
                                    <th class="text-center text-nowrap"><?= trans('parent_category'); ?></th>
                                    <th class="text-center text-nowrap"><?= trans('order_1'); ?></th>
                                    <!-- <th class="text-center text-nowrap"><?= trans('color'); ?></th> -->
                                    <th class="max-width-120 text-center text-nowrap"><?= trans('options'); ?></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if (!empty($categories)):
                                    foreach ($categories as $item): ?>
                                        <tr>
                                            ...
                                            <td class="text-start text-nowrap"><?= esc($item->name); ?></td>
                                            ...
                                            <td class="text-center text-nowrap"><?= esc($item->category_order); ?></td>
                                            <!-- <td>
