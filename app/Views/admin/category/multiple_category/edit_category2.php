...
<div class="row">
    <div class="col-lg-8 col-md-12">
        <div class="box box-primary">
            ...
            <?= csrf_field(); ?>
            <input type="hidden" id="definition_id" name="definition_id" value="<?= esc($definition_id); ?>">
            ...
            <div class="box-body pt-0" style="padding-top: 0px;">
                ...
                <div class="form-group">
                    ...
                    <select id="parent_id" class="form-control" name="parent_id" onchange="hideParentCategoryInputs(this.value);">
                        ...
                        <?php if (!empty($parentCategories)):
                            ...
                            <option value="<?= $item->id; ?>" <?= $categoryDataByLang[$generalSettings->site_lang]['parent_id'] == $item->id ? 'selected' : ''; ?>><?= esc($item->name); ?></option>
                            <?php endforeach;
                        endif; ?>
                    </select>
                </div>
                ...
                <div class="tab-content">
                    <?php foreach ($activeLanguages as $index => $language): ?>
                        <input type="hidden" id="categories[<?= $language->id; ?>][id]" name="categories[<?= $language->id; ?>][id]" value="<?= esc($categoryDataByLang[$language->id]['id']); ?>">
                        ...
                        <div class="tab-pane <?= $index === 0 ? 'active' : ''; ?>" 
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" name="categories[<?= $language->id; ?>][name]" 
                                    placeholder="<?= trans("category_name"); ?>" value="<?= $categoryDataByLang[$language->id]['name']; ?>" maxlength="200" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="categories[<?= $language->id; ?>][slug]" 
                                    placeholder="<?= trans("slug"); ?>" value="<?= $categoryDataByLang[$language->id]['name_slug']; ?>">
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="category_order" type="number" class="form-control" name="category_order" 
                    placeholder="<?= trans('order'); ?>" value="<?= $categoryDataByLang[$generalSettings->site_lang]['category_order']; ?>" min="0" required>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_on_menu_1" name="show_on_menu" value="1" class="square-purple" <?= $categoryDataByLang[$generalSettings->site_lang]['show_on_menu'] == '1' ? 'checked' : ''; ?>>
                            <label for="rb_show_on_menu_1" class="cursor-pointer"><?= trans('yes'); ?></label>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_on_menu_2" name="show_on_menu" value="0" class="square-purple" <?= $categoryDataByLang[$generalSettings->site_lang]['show_on_menu'] != '1' ? 'checked' : ''; ?>>
                ...
                <div class="form-group input-parent">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_at_footer_1" name="show_at_footer" value="1" class="square-purple" <?= $categoryDataByLang[$generalSettings->site_lang]['show_at_footer'] == '1' ? 'checked' : ''; ?>>
                            <label for="rb_show_at_footer_1" class="cursor-pointer"><?= trans('yes'); ?></label>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_at_footer_2" name="show_at_footer" value="0" class="square-purple" <?= $categoryDataByLang[$generalSettings->site_lang]['show_at_footer'] != '1' ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_at_homepage_1" name="show_at_homepage" value="1" class="square-purple" <?= $categoryDataByLang[$generalSettings->site_lang]['show_at_homepage'] == '1' ? 'checked' : ''; ?>>
                            <label for="rb_show_at_homepage_1" class="cursor-pointer"><?= trans('yes'); ?></label>
                        </div>
                        <div class="col-md-3 col-sm-4 col-xs-12 col-option">
                            <input type="radio" id="rb_show_at_homepage_2" name="show_at_homepage" value="0" class="square-purple" <?= $categoryDataByLang[$generalSettings->site_lang]['show_at_homepage'] != '1' ? 'checked' : ''; ?>>
                ...
                <div class="form-group" id="show_at_body_sort_group">
                    ...
                    <input id="show_at_body_sort" type="number" class="form-control" name="show_at_body_sort" placeholder="<?= trans('show_at_body_sort'); ?>" value="<?= $categoryDataByLang[$generalSettings->site_lang]['show_at_body_sort']; ?>" min="0" max="3000">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <?php $imgBaseURL = getBaseURLByStorage($categoryDataByLang[$generalSettings->site_lang]['storage']); ?>
                            <img src="<?= $imgBaseURL . esc($categoryDataByLang[$generalSettings->site_lang]['file_path']); ?>" alt="" class="thumbnail img-responsive" style="max-width: 300px; max-height: 300px;">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="row">
                ...
                <div class="box-footer">
                    <button class="btn btn-primary pull-right" onclick="submitFormsAsJSON()"><?= trans('save_changes'); ?></button>
                </div>
            </div>
    </div>
</div>
...
<script>
    function submitFormsAsJSON() {
        ...
        formData.append('definition_id', document.getElementById('definition_id').value);
        ...
        languageForms.forEach(form => {
            ...
            formData.append(`categories[${langId}][id]`, document.getElementById(`categories[${langId}][id]`).value);
        });
        ...
        fetch('<?= base_url("CategoryController/editCategoryPost2"); ?>', {
            method: 'POST',
            headers: {
