...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/vendor/icheck/square/red.css'); ?>">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li><a class="btn btn-sm btn-primary pull-left btn-site-prev" target="_blank" href="<?= base_url(); ?>"><i class="fa fa-eye"></i> <?= trans("view_site"); ?></a></li>
                    ...
                    if (checkUserPermission('add_post')): ?>
                        ...
                        <li class="treeview<?php isAdminNavActive(['posts', 'slider-posts', 'featured-posts', 'breaking-news', 'recommended-posts', 'pending-posts', 'scheduled-posts', 'drafts', 'update-post']); ?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="nav-post-format nav-add-post"><a href="<?= adminUrl('add-post'); ?>"><?= trans("add_post"); ?></a></li>
