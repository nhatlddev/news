        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('AdminController/addPagePost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group d-flex justify-content-between gap-3 flex-column flex-md-row">
                    ...
                    <div class="form-group d-flex justify-content-between gap-3">
                        ...
                        <div class="form-group w-100">
                            ...
                            <input type="number" class="form-control" name="page_order" placeholder="<?= trans('order'); ?>" value="1" min="1" max="3000" >
                        </div>     
                    </div>
